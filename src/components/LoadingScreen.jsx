                ...
                <g style={{ transformOrigin: '282px 230px' }}>
                    ...
                    <g transform="translate(65, 0)">
                        {[272, 288, 304, 320, 336, 352].map((cx, i) => (
                            <line key={i} x1={cx} y1="162" x2={cx} y2="130" stroke="#222" strokeWidth="4" strokeLinecap="round" />
                        ))}
                    </g>
                    <circle cx="352" cy="218" r="5" fill="#222" />
                    <circle cx="412" cy="218" r="5" fill="#222" />
            ...
            <g transform="translate(-20, 0)">
                <g style={{ transformOrigin: '282px 336px' }}>
                    ...
                    {[230, 320, 410].map((cx, i) => (
                        <g key={i}>
                            <circle cx={cx + 3} cy="345" r="11" fill="rgba(0,0,0,0.15)" />
                            <circle cx={cx} cy="342" r="11" fill="#3050A0" />
                        </g>
                    ))}
